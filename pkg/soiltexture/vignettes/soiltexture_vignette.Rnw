...
To display a Polish texture triangle (Systematyka gleb Polski, 
...
Note: Michal Stepien, Warsaw University of Life Sciences, 
...
above, here be refered to as "Polish PTG 1956-1959", has for 
original references "Przyrodniczo-genetyczna klasyfikacja gleb 
Polski, 1956. Roczniki Nauk Rolniczych, 74, seria D: 1-96" and 
"Genetyczna klasyfikacja gleb Polski, 1959. Roczniki 
Gleboznawcze - Soil Science Annual, 7(2): 1-103". This triangle 
has more classes than another similar triangle (not presented 
here), here refered to as "PTG 1956 Musierowicz", and whose 
references are "Musierowicz A. 1956. Gleboznawstwo ogolne. 
Systematyka Gleb Polski, 1989. Roczniki Gleboznawcze - 
Soil Science Annual, 40(3/4): 1-150". These indications 
may be subject to update or clarification.
...
<<echo=TRUE,fig=TRUE,include=TRUE>>= 
TT.plot( class.sys = "Polish_BN_1978.TT" ) 
@ 
...
<<echo=FALSE,results=hide,quiet=TRUE>>= 
plLim <- TT.get("Polish_BN_1978.TT")[["base.css.ps.lim"]][3]
@ 
...
<<echo=FALSE,results=tex>>= 
tex.tbl <- TT.classes.tbl( class.sys = "Polish_BN_1978.TT" ) 
xtable( 
    x       = tex.tbl[,-3],  #
    caption = "Polish texture triangle (BN-78/9180-11)", 
    label   = NULL  
)   #
@ 
